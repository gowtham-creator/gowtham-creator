<div align="center">
  <picture>
    ...
    <img src="assets/banner-light.svg" width="100%" alt="Nayini Gowtham Reddy: AI Engineer and Full-Stack Engineer, Hyderabad">
  </picture>
</div>
...
<picture>
  ...
  <img src="assets/skills/ai-light.svg" width="100%" alt="AI and LLM: Claude, OpenAI, Gemini, Llama, Mistral, Ollama, LangChain, LangGraph, LlamaIndex, CrewAI, Claude Code, n8n, Pinecone, Chroma">
</picture>

<picture>
  <source media="(prefers-color-scheme: dark)" srcset="assets/skills/ml-dark.svg">
  <img src="assets/skills/ml-light.svg" width="100%" alt="ML and data: Python, PyTorch, TensorFlow, Keras, scikit-learn, pandas, NumPy, OpenCV, Jupyter, Streamlit">
</picture>

<picture>
  <source media="(prefers-color-scheme: dark)" srcset="assets/skills/frontend-dark.svg">
  <img src="assets/skills/frontend-light.svg" width="100%" alt="Frontend: React, Next.js, TypeScript, JavaScript, Tailwind, shadcn/ui, Three.js, GSAP, Framer Motion, Vite, HTML5, CSS3, Figma, Flutter, Dart">
</picture>
...
| **[AI Timetable Engine](https://github.com/gowtham-creator/AI-Timetable-NXT-Schools)** | Clash-free timetables for a production school ERP. A deterministic solver builds the schedule; the LLM only reads the rules. 270/270 periods placed. | PHP · Yii2 · Gemini · Claude |
| **[NXT School ID](https://github.com/gowtham-creator/nxt-schools-id)** | ID-card platform with a template designer, bulk Excel import, and print-ready CR80 and QR IDs. | Next.js 16 · Supabase RLS · Playwright · Vitest |
...
<div align="center">
  <picture>
    ...
    <img src="assets/stats/overview-light.svg" width="49%" alt="GitHub activity over the last 12 months">
  </picture>
  <picture>
    <source media="(prefers-color-scheme: dark)" srcset="assets/stats/languages-dark.svg">
    <img src="assets/stats/languages-light.svg" width="49%" alt="Most used languages across public repositories">
  </picture>
</div>
...
<div align="center">
  <picture>
    ...
    <img src="https://raw.githubusercontent.com/gowtham-creator/gowtham-creator/output/snake-light.svg" width="100%" alt="Contribution graph being eaten by a snake">
  </picture>
</div>
